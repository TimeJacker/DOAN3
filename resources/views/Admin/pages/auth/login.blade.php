                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="{{ asset('User/') }}/image/logo1.png" width="180"
                                        alt="">
                                </a>
                                ...
                                <form action="{{ route('login') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <p class="fs-4 mb-0 fw-bold">Bạn chưa có tài khoản?</p>
                                        <a class="text-primary fw-bold ms-2" href="{{ route('showregister') }}">Đăng
                                            kí</a>
                                    </div>
                                    {{-- </button> --}}
                                    {{-- <div class="d-flex align-items-center justify-content-center">
