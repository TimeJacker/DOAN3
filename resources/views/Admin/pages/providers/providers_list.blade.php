    ...
    <div class="container-fluid ">
        ...
        <div class="row ">
            <div class="card border">
                <div class="card-body">
                    {{-- <h5 class="card-title fw-semibold mb-4">Nhà cung cấp</h5> --}}
                    <h5 class="mb-0 card-title fw-semibold ">Nhà cung cấp </h5>
                </div>
            </div>
        </div>
        {{-- lọc --}}
            ...
            <div class="card border">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <label>Nhập tên nhà cung cấp để tìm kiếm</label>
                            <form action="{{ route('providersIndex') }}" method="get" enctype="multipart/form-data">
                        ...
                        <div class="col-4">
                            <a href="{{ route('providersCreate') }}"> <button type="button"
                                    class="btn btn-primary m-1 float-end" title="Thêm mới nhà cung cấp"><i
                            ...
                            <tbody>
                                @foreach ($providers as $key => $value)
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <a href="{{ route('providersEdit', $value->id) }}" title="Sửa nhà cung cấp"><i
                                                    class="ti ti-edit fs-8"></i></a>
                                            <a href="" data-bs-toggle="modal" data-bs-target="#exampleModal_{{ $value->id }}"
                                                title="Xóa nhà cung cấp"><i class="ti ti-trash-x fs-8"></i></a>
                                                <!-- Modal -->
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{ route('providersDelete', $value->id) }}"
