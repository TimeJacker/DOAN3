                ...
                <ul class="nav nav-left medium-nav-center nav-small  nav-divided">
                    <li class="header-contact-wrapper">
                        <ul id="header-contact" class="nav nav-divided nav-uppercase header-contact">
                            ...
                            <li class="">
                                <a href="mailto:agc18.auto@gmail.com" class="tooltip" title="tuananh@gmail.com">
                                   <i class="fa-regular fa-envelope"  style="font-size:16px;"></i><span>
                                        tuananh@gmail.com </span>
                                </a>
                            </li>
                            <li class="">
    ...
    <div id="masthead" class="header-main hide-for-sticky">
        <div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
            ...
            <div id="logo" class="flex-col logo">
                ...
                <!-- Header logo -->
                <a href="" title="Công ty phân phối phụ kiện &#8211; phụ tùng xe đạp điện  "
                    rel="home">
                    <img width="894" height="552" src="{{ asset('User/') }}/image/logo1.png"
                        class="header_logo header-logo" alt="Công ty phân phối phụ kiện &#8211; phụ tùng xe đạp điện" />
                        <img
                        width="894" height="552" src="{{ asset('User/') }}/image/logo1.png"
                        class="header-logo-dark" alt="Công ty phân phối phụ kiện &#8211; phụ tùng xe đạp điện" /></a>
            </div>
