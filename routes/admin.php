...
Route::prefix('admin')->group(function () {
    ...
    //nhà cung cấp
    Route::prefix('Providers')->middleware('auth','admin')->group(function () {
        Route::get('', [ProvidersController::class, 'index'])->name('providersIndex');
        Route::get('add', [ProvidersController::class, 'create'])->name('providersCreate');
        Route::post('add', [ProvidersController::class, 'store'])->name('providersStore');
        Route::get('edit/{id}', [ProvidersController::class, 'edit'])->name('providersEdit');
        Route::get('update/{id}', [ProvidersController::class, 'update'])->name('providersUpdate');
        Route::delete('delete/{id}', [ProvidersController::class, 'delete'])->name('providersDelete');
    });
